...
| Selection and path utilities | `tests/App.test.tsx` copy-path, select-same-type, refresh-retains-existing-selection, filtered-anchor shift-click fallback, and rename-selects-new-item coverage |
